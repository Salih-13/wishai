...
export default function Home() {
  ...
  Generate a thoughtful and heartfelt special occasion card message iclude emojis to make the text look more cheerful. 
    ...
    <div className="w-full max-w-lg bg-white bg-opacity-90 rounded-lg p-8 shadow-xl">
      ...
      <div className="mb-4">
        ...
        >
          ...
          <option className="text-black" value="Anniversary">Graduation</option>
